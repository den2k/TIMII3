...
// TODO: 1.13.19 - Refactor NewTimerScreen name --> CreateTimerScreen
...
class NewTimerScreen: UIViewController, LayoutLoading
{
    ...
    {
        guard let name = nameTextField?.text, !name.isEmpty, let description = descriptionTextField?.text else
        {
